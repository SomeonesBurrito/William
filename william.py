...
# Importing the google genai library to get ai responses for questions 
...
# This function finds content within the website or search engine
...
def ask_question(question):
    GOOGLE_API_KEY = "INSERT UR KEY HERE"  
...
while True:
    ...
    if "william" in command:
        ...
        # If the user asks a question it will go to the ai function
        elif "ask" in command:
